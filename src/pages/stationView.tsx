  ...
  return (
    <Container sx={{ display: 'flex', justifyContent: 'center', margin: 6 }}>
      <Box>
        ...
        <Typography>Average departuring journey length: {station["Average departure length"].toFixed(0)}m</Typography>
        <Typography>Returns: {station?.Returns}</Typography>
        <Typography>Average returning journey length: {station["Average return length"].toFixed(0)}m</Typography>
